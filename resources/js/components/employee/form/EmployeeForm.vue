        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <el-form-item label="Monthly Salary" prop="salary">
                    <el-input type="number" v-model="form.salary" placeholder="Monthly Salary."></el-input>
                </el-form-item>
            </div>
            <div class="col-md-6">
    ...
    created() {
        ...
        if(this.model && this.model.id && this.mode == 'update') {
            ...
            this.form = {
                ...
                is_contribution: this.model.is_contribution,
        ...
        model(newVal, oldVal) {
            if(newVal != oldVal) {
                ...
                this.form = {
                    ...
                    is_contribution: newVal.is_contribution,
